# pysimpleGUI for analysis of compiled behavior Excel file to output graphs and p-values
...
def graph_data_calc_p_vals(input_file):
    ...
    Gq_NS = df[virus_Gi_grp & shock_NS_grp]
    Gq_FS = df[virus_Gi_grp & shock_FS_grp]
    ...
    axes[1,0].text(0.5, max(tm_shock_grps), f'P = {tm_sk_p_value:.4f}', ha='center', va='bottom')
